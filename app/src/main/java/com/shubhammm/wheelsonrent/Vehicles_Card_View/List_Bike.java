 ...
 */
public class List_Bike extends Fragment {
...
//    FragmentTransaction fragmentTransaction;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
      ...
      //  return inflater.inflate(R.layout.fragment_list__bike, container, false);
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference("List_Bike");
...
//        post_list.setLayoutManager(new LinearLayoutManager(HomeFragment.this.getActivity()));
    ...
    public void onStart(){
        ...
        FirebaseRecyclerAdapter<post_firebase,List_Bike.PostHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter
                <post_firebase,List_Bike.PostHolder>
                (post_firebase.class,R.layout.firebase_post,List_Bike.PostHolder.class,mDatabase){

            public void populateViewHolder(List_Bike.PostHolder viewHolder, post_firebase model ,int position){
